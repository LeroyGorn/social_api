...
from apps.posts.serializers import LikeSerializer, UserPostSerializer, UserPostListSerializer
...
class LikeAnalyticsView(APIView):
    ...
    def get_filter_condition(self):
        condition_dict = {
            'date_from': Q(created_on__gte=self.request.query_params.get('date_from')),
            'date_to': Q(created_on__lte=self.request.query_params.get('date_to'))
        }
        filter_condition = Q()
